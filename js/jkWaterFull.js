 ...
 * @param {*} child class类型
 */
function jkWaterFull(parent,child) {
    //1.父盒子居中
    ...
    for (var i = 0; i < allBox.length; i ++ ) {
        ...
        if (i < cols) {//第一行
            ...
            //求出最矮盒子对应的索引
            minBoxIndex = jkGetMinBoxIndex(heightArr,minBoxHeight);
            //子盒子定位
            allBox[i].style.position = 'absolute';
 ...
 * @returns
 */
function jkGetMinBoxIndex(arr,val) {
